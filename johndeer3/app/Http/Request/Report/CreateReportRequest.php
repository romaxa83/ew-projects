...
/**
 * @OA\Schema(type="object", title="Create Report Request",
...
class CreateReportRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'clients.*.model_description_id' => ['nullable', 'integer', 'exists:jd_model_descriptions,id'],
...
//            'machines.*.model_description_id' => ['nullable', 'integer', 'exists:jd_model_descriptions,id'],
            ...
            'files.'.Image::WORKING_START => ['nullable', 'array', 'min:1','max:2'],
            'files.'.Image::WORKING_START .'.*' => ['image', 'mimes:jpeg,jpg,png'],
            'files.'.Image::WORKING_END => ['nullable', 'array', 'min:1','max:2'],
            'files.'.Image::WORKING_END .'.*' => ['image', 'mimes:jpeg,jpg,png'],
            'files.'.Image::EQUIPMENT => ['nullable', 'array', 'min:1','max:5'],
            'files.'.Image::EQUIPMENT .'.*' => ['image', 'mimes:jpeg,jpg,png'],
            'files.'.Image::ME => ['nullable', 'array', 'min:1','max:5'],
            'files.'.Image::ME .'.*' => ['image', 'mimes:jpeg,jpg,png'],
            'files.'.Image::OTHERS => ['nullable', 'array', 'min:1','max:5'],
            'files.'.Image::OTHERS .'.*' => ['image', 'mimes:jpeg,jpg,png'],
            'files.'.Image::SIGNATURE => ['nullable','array'],
            'files.'.Image::SIGNATURE .'.*' => ['nullable','string'],
        ];
    }
}
