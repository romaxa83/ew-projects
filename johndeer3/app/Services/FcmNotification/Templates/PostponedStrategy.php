...
class PostponedStrategy implements TemplateStrategyParse
{
    private $lang;
    ...
    public function parse(FcmTemplate $template, Model $model, $lang = null): Templatable
    {
        ...
        $vars['previous_date_time'] = $this->getPreviousDateTime($model);
    ...
    private function getPreviousDateTime($model): string
    {
        return $model->pushData->prev_planned_at ?? '';
    }
