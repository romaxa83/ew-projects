...
/**
 * @OA\Schema(type="object", title="Report Crop Response",
 ...
 *             @OA\Property(property="crop_name", type="string", description="Название культуры", example="озима"),
