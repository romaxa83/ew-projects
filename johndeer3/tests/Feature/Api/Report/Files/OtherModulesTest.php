...
class OtherModulesTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $url = "report/{$id}/". Image::OTHERS."_1.jpg";
        ...
        $this->assertEquals($imageModel->model, Image::OTHERS);
    ...
    public function success_as_jpeg_extension()
    {
        ...
        $data['files'] = [
            Image::OTHERS => [
                UploadedFile::fake()->image(Image::OTHERS."_1.jpeg"),
            ]
        ];
        ...
        $id = data_get($res, 'data.id');
        $url = "report/{$id}/". Image::OTHERS."_1.jpeg";
        Storage::disk('public')->assertExists($url);
    }
    ...
    public function success_as_png_extension()
    {
        ...
        $data['files'] = [
            Image::OTHERS => [
                UploadedFile::fake()->image(Image::OTHERS."_1.png"),
            ]
        ];
        ...
        $id = data_get($res, 'data.id');
        $url = "report/{$id}/". Image::OTHERS."_1.png";
        Storage::disk('public')->assertExists($url);
    }
    ...
    public function fail_as_pdf_extension()
    {
        ...
        $data['files'] = [
            Image::OTHERS => [
                UploadedFile::fake()->image(Image::OTHERS."_1.pdf"),
            ]
        ];
        ...
        $this->postJson(route('api.report.create'), $data,[
            ...
            ->assertJson($this->structureErrorResponse([
                "The files.".Image::OTHERS.".0 must be an image.",
                "The files.".Image::OTHERS.".0 must be a file of type: jpeg, jpg, png."
            ]))
    ...
    public function fail_as_gif_extension()
    {
        ...
        $data['files'] = [
            Image::OTHERS => [
                UploadedFile::fake()->image(Image::OTHERS."_1.gif"),
            ]
        ];
    ...
    public function fail_more_file()
    {
        ...
        $data['files'] = [
            Image::OTHERS => [
                UploadedFile::fake()->image(Image::OTHERS."_1.png"),
                UploadedFile::fake()->image(Image::OTHERS."_2.png"),
                UploadedFile::fake()->image(Image::OTHERS."_3.png"),
                UploadedFile::fake()->image(Image::OTHERS."_4.png"),
                UploadedFile::fake()->image(Image::OTHERS."_5.png"),
                UploadedFile::fake()->image(Image::OTHERS."_6.png"),
            ]
        ];
        ...
        $this->postJson(route('api.report.create'), $data,[
            ...
            ->assertJson($this->structureErrorResponse([
                "The files.".Image::OTHERS." may not have more than 5 items.",
            ]))
            ->assertJsonCount(1, 'data')
        ;
    }
