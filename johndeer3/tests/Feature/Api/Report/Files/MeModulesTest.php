...
class MeModulesTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $this->assertEquals($imageModel->model, Image::ME);
    ...
    public function success_as_jpeg_extension()
    {
        ...
        $data['files'] = [
            Image::ME => [
                UploadedFile::fake()->image(Image::ME."_1.jpeg"),
            ]
        ];
        ...
        $id = data_get($res, 'data.id');
        $url = "report/{$id}/". Image::ME."_1.jpeg";
        Storage::disk('public')->assertExists($url);
    }
    ...
    public function success_as_png_extension()
    {
        ...
        $data['files'] = [
            Image::ME => [
                UploadedFile::fake()->image(Image::ME."_1.png"),
            ]
        ];
    ...
    public function fail_as_pdf_extension()
    {
        ...
        $data['files'] = [
            Image::ME => [
                UploadedFile::fake()->image(Image::ME."_1.pdf"),
            ]
        ];
        ...
        $this->postJson(route('api.report.create'), $data,[
            ...
            ->assertJson($this->structureErrorResponse([
                "The files.".Image::ME.".0 must be an image.",
                "The files.".Image::ME.".0 must be a file of type: jpeg, jpg, png."
            ]))
    ...
    public function fail_as_gif_extension()
    {
        ...
        $data['files'] = [
            Image::ME => [
                UploadedFile::fake()->image(Image::ME."_1.gif"),
            ]
        ];
    ...
    public function fail_more_file()
    {
        ...
        $data['files'] = [
            Image::ME => [
                UploadedFile::fake()->image(Image::ME."_1.png"),
                UploadedFile::fake()->image(Image::ME."_2.png"),
                UploadedFile::fake()->image(Image::ME."_3.png"),
                UploadedFile::fake()->image(Image::ME."_4.png"),
                UploadedFile::fake()->image(Image::ME."_5.png"),
                UploadedFile::fake()->image(Image::ME."_6.png"),
            ]
        ];
        ...
        $this->postJson(route('api.report.create'), $data,[
            ...
            ->assertJson($this->structureErrorResponse([
                "The files.".Image::ME." may not have more than 5 items.",
            ]))
            ->assertJsonCount(1, 'data')
        ;
    }
