...
class EquipmentModulesTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $url = "report/{$id}/". Image::EQUIPMENT."_1.jpg";
        ...
        $this->assertEquals($imageModel->model, Image::EQUIPMENT);
    ...
    public function success_as_jpeg_extension()
    {
        ...
        $data['files'] = [
            Image::EQUIPMENT => [
                UploadedFile::fake()->image(Image::EQUIPMENT."_1.jpeg"),
            ]
        ];
        ...
        $res = $this->postJson(route('api.report.create'), $data,[
            ...
            ->assertJson($this->structureResource([
                'images' => [
                    [
                        'basename' => Image::EQUIPMENT."_1.jpeg",
                    ],
                ]
            ]))
            ->assertJsonCount(2, 'data.images')
        ...
        $id = data_get($res, 'data.id');
        $url = "report/{$id}/". Image::EQUIPMENT."_1.jpeg";
        Storage::disk('public')->assertExists($url);
    }
    ...
    public function success_as_png_extension()
    {
        ...
        $data['files'] = [
            Image::EQUIPMENT => [
                UploadedFile::fake()->image(Image::EQUIPMENT."_1.png"),
            ]
        ];
        ...
        $res = $this->postJson(route('api.report.create'), $data,[
            ...
            ->assertJson($this->structureResource([
                'images' => [
                    [
                        'basename' => Image::EQUIPMENT."_1.png",
                    ],
                ]
            ]))
            ->assertJsonCount(2, 'data.images')
        ...
        $id = data_get($res, 'data.id');
        $url = "report/{$id}/". Image::EQUIPMENT."_1.png";
        Storage::disk('public')->assertExists($url);
    }
    ...
    public function fail_as_pdf_extension()
    {
        ...
        $data['files'] = [
            Image::EQUIPMENT => [
                UploadedFile::fake()->image(Image::EQUIPMENT."_1.pdf"),
            ]
        ];
        ...
        $this->postJson(route('api.report.create'), $data,[
            ...
            ->assertJson($this->structureErrorResponse([
                "The files.".Image::EQUIPMENT.".0 must be an image.",
                "The files.".Image::EQUIPMENT.".0 must be a file of type: jpeg, jpg, png."
            ]))
    ...
    public function fail_as_gif_extension()
    {
        ...
        $data['files'] = [
            Image::EQUIPMENT => [
                UploadedFile::fake()->image(Image::EQUIPMENT."_1.gif"),
            ]
        ];
    ...
    public function fail_more_file()
    {
        ...
        $data['files'] = [
            Image::EQUIPMENT => [
                UploadedFile::fake()->image(Image::EQUIPMENT."_1.png"),
                UploadedFile::fake()->image(Image::EQUIPMENT."_2.png"),
                UploadedFile::fake()->image(Image::EQUIPMENT."_3.png"),
                UploadedFile::fake()->image(Image::EQUIPMENT."_4.png"),
                UploadedFile::fake()->image(Image::EQUIPMENT."_5.png"),
                UploadedFile::fake()->image(Image::EQUIPMENT."_6.png"),
            ]
        ];
        ...
        $this->postJson(route('api.report.create'), $data,[
            ...
            ->assertJson($this->structureErrorResponse([
                "The files.".Image::EQUIPMENT." may not have more than 5 items.",
            ]))
            ->assertJsonCount(1, 'data')
        ;
    }
