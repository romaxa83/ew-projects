...
class ReportCropTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $data = [
            ...
            'eg' => [$md_1->equipmentGroup->id, $md_1->equipmentGroup->id],
            'md' => [$md_1->id, $md_1_1->id],
            'crop' => [$feature_1->values[0]->id, $feature_1->values[1]->id],
        ];

        $this->getJson(route('api.v2.statistic.crop.report', $data),[
