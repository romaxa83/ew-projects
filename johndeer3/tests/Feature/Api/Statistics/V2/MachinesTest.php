...
class MachinesTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $this->getJson(route('api.v2.statistic.machines', $data),[
    ...
    public function fail_string_field()
    {
        ...
        $this->getJson(route('api.v2.statistic.machines', $data),[
            ...
            ->assertJson($this->structureErrorResponse("Value [yes] - is not numeric"))
        ;
    }
    ...
    public function fail_repo_return_exception()
    {
        ...
        $this->mock(statisticMachineService::class, function(MockInterface $mock){
            $mock->shouldReceive("statisticMachines")
