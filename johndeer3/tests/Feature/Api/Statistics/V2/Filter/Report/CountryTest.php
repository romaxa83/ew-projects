...
class CountryTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $this->getJson(route('api.v2.statistic.report.filter.country', $data))
    ...
    public function fail_service_return_exception()
    {
        ...
        $this->mock(StatisticFilterService::class, function(MockInterface $mock){
            $mock->shouldReceive("reportCountryData")
    ...
    public function not_auth()
    {
        ...
        $this->getJson(route('api.v2.statistic.report.filter.status', $data))
