...
class FilterEGTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $this->getJson(route('api.statistic.report.filter.eg', $data))
    ...
    /** @test */
    public function success_only_combine_empty()
    {
        $admin = $this->userBuilder->create();
        $this->loginAsUser($admin);
    ...
    /** @test */
    public function success_only_combine_result()
    {
        $admin = $this->userBuilder->create();
        $this->loginAsUser($admin);
        ...
        $eg_1 = EquipmentGroup::query()->where('name', 'COMBINE HEADS')->first();
        $eg_2 = EquipmentGroup::query()->where('name', 'Combines')->first();
    ...
    public function success_some_fields()
    {
        ...
        $data = [
            'year' => Carbon::now()->year,
            'status' => ReportStatus::CREATED.','.ReportStatus::IN_PROCESS,
            'country' => $fr.','.$de,
            'dealer' => $dealerFR_1->id . ',' . $dealerDE->id
        ];
