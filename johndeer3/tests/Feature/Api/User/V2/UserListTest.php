...
namespace Tests\Feature\Api\User\V2;
...
class UserListTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $this->getJson(route('v2.admin.user.index'))
            ->assertJsonStructure([
                "data" => [
                    [
                        "id",
    ...
    public function success_query_page()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['page' => 3]))
            ->assertJson([
                "meta" => [
                    "current_page" => 3
                ]
    ...
    public function success_query_per_page()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['per_page' => 2]))
            ->assertJson([
                "meta" => [
                    "per_page" => 2,
                    "total" => 4
    ...
    public function success_query_role()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['role' => Role::ROLE_PS]))
            ->assertJson([
                "meta" => [
                    "total" => 3
                ]
        ...
        $this->getJson(route('v2.admin.user.index', ['role' => Role::ROLE_PSS]))
            ->assertJson([
                "meta" => [
                    "total" => 1
                ]
        ...
        $this->getJson(route('v2.admin.user.index', ['role' => Role::ROLE_ADMIN]))
            ->assertJson([
                "meta" => [
                    "total" => 0
                ]
        ...
        $this->getJson(route('v2.admin.user.index', ['role' => Role::ROLE_SM]))
            ->assertJson([
                "meta" => [
                    "total" => 0
                ]
    ...
    public function success_query_login()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['login' => 'ret']))
            ->assertJson([
                "meta" => [
                    "total" => 2
                ]
    ...
    public function success_query_email()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['email' => $email]))
            ->assertJson([
                "meta" => [
                    "total" => 1
                ]
    ...
    public function success_query_country()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['country_id' => $country_1->id]))
            ->assertJson([
                "meta" => [
                    "total" => 1
                ]
        ...
        $this->getJson(route('v2.admin.user.index', ['country_id' => $country_2->id]))
            ->assertJson([
                "meta" => [
                    "total" => 3
                ]
    ...
    public function success_query_wrong_country_id()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['country_id' => 9999]))
            ->assertJson([
                "meta" => [
                    "total" => 0
                ]
    ...
    public function success_query_dealer_as_ps()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['dealer' => $dealer_1->name]))
            ->assertJson([
                "meta" => [
                    "total" => 1
                ]
        ...
        $this->getJson(route('v2.admin.user.index', ['dealer' => $dealer_2->name]))
            ->assertJson([
                "meta" => [
                    "total" => 3
                ]
        ...
        $this->getJson(route('v2.admin.user.index', ['dealer' => 'empty']))
            ->assertJson([
                "meta" => [
                    "total" => 0
                ]
    ...
    public function success_query_dealers_as_tm()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['dealer' => $dealer_3->name]))
            ->assertJson([
                "meta" => [
                    "total" => 2
                ]
        ...
        $this->getJson(route('v2.admin.user.index', ['dealer' => $dealer_4->name]))
            ->assertJson([
                "meta" => [
                    "total" => 0
                ]
    ...
    public function success_query_name()
    {
        ...
        $this->getJson(route('v2.admin.user.index', ['name' => 'Tara']))
            ->assertJson([
                "meta" => [
                    "total" => 2
                ]
        ...
        $this->getJson(route('v2.admin.user.index', ['name' => 'Tara_Shevc']))
            ->assertJson([
                "meta" => [
                    "total" => 1
                ]
        ...
        $this->getJson(route('v2.admin.user.index', ['name' => 'Shevchenko']))
            ->assertJson([
                "meta" => [
                    "total" => 1
                ]
    ...
    /** @test */
    public function success_active_and_not_active()
    {
        $admin = $this->userBuilder->create();
        $this->loginAsUser($admin);
