...
@push('extendHeader')
    <link rel="stylesheet" media="screen, print" href="/smartadmin/css/miscellaneous/reactions/reactions.css">
    <link rel="stylesheet" media="screen, print" href="/smartadmin/css/miscellaneous/fullcalendar/fullcalendar.bundle.css">
    <link rel="stylesheet" media="screen, print" href="/smartadmin/css/miscellaneous/jqvmap/jqvmap.bundle.css">
...
@push('extendFooter')
    ...
    <script src="/smartadmin/js/statistics/peity/peity.bundle.js"></script>
    <script src="/smartadmin/js/statistics/flot/flot.bundle.js"></script>
    <script src="/smartadmin/js/statistics/easypiechart/easypiechart.bundle.js"></script>
