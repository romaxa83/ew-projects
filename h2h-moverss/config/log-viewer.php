...
return [
    ...
    */
    ...
    'require_auth_in_production' => env('LOG_VIEWER_REQUIRE_AUTH', true),
    ...
    */
    ...
    'route_path' => 'log-viewer-wdpGBBBBlLS9sMjAfeDxgTHplwovTM5ePiKgJcHULnS1X1r33To9CVmNfz8Yb12Q',
    ...
    */
    ...
    'hosts' => [
        ...
        //
         'production' => [
             'name' => 'Production',
             'host' => env('APP_URL', 'local') . 'log-viewer-wdpGBBBBlLS9sMjAfeDxgTHplwovTM5ePiKgJcHULnS1X1r33To9CVmNfz8Yb12Q',
