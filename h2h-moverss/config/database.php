    ...
    */
    ...
    'connections' => [
        ...
        DbConnections::RINGOSTAT => [
            'driver' => 'mysql',
            'host' => env('DB_HOST_RINGOSTAT', '127.0.0.1'),
            'port' => env('DB_PORT_RINGOSTAT', '3306'),
            'database' => env('DB_DATABASE_RINGOSTAT', 'forge'),
            'username' => env('DB_USERNAME_RINGOSTAT', 'forge'),
            'password' => env('DB_PASSWORD_RINGOSTAT', ''),
            'unix_socket' => env('DB_SOCKET_RINGOSTAT', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
        ...
        DbConnections::MAILBOX => [
            'driver' => 'mysql',
            'url' => env('DATABASE_URL'),
            'host' => env('DB_HOST', '127.0.0.1'),
            'port' => env('DB_PORT_MAILBOXES', '3306'),
            'database' => env('DB_DATABASE_MAILBOXES', 'forge'),
            'username' => env('DB_USERNAME', 'forge'),
            'password' => env('DB_PASSWORD', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
