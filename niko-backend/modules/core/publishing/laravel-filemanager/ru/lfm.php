...
return [
    ...
    'message-drop' => 'Или добавьте файлы сюда, чтобы загрузить',
    ...
    'error-size' => 'Превышен размер файла size:',
    ...
    'btn-close' => 'Закрыть',
    'btn-crop' => 'Обрезать',
    'btn-copy-crop' => 'Скопировать и Обрезать',
    'btn-crop-free' => 'Произвольно',
    'btn-cancel' => 'Отмена',
