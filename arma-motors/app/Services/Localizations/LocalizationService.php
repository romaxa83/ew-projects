...
class LocalizationService
{
    ...
    public function getDefaultSlugByAdmin(): string
    {
        return $this->getDefaultAdmin()->slug;
    }
    ...
    public function getDefaultAdmin(): Language
    {
        return Language::defaultAdmin()->first();
    }
    ...
    {
        return $this->getAllLanguages()->pluck('slug')->toArray();
    }
}
