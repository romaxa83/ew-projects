...
class SupportCategoryActiveToggleTest extends TestCase
{
    ...
    public function toggle_success()
    {
        ...
        $model = $this->supportBuilder()->onlyCategory()->create();
        ...
        $responseData = $response->json('data.supportCategoryToggleActive');
    ...
    public static function getQueryStr(string $id): string
    {
        return sprintf('
            mutation {
                supportCategoryToggleActive(id: "%s") {
                    id
                    active
                    sort
                }
