...
class SupportCategoryEditTest extends TestCase
{
    ...
    public function success()
    {
        $admin = $this->adminBuilder()
            ->createRoleWithPerm(Permissions::SUPPORT_CATEGORY_EDIT)
            ->create();
        $this->loginAsAdmin($admin);

        $builder = $this->supportBuilder();
        $model = $builder->onlyCategory()->create();
        ...
        $responseData = $response->json('data.supportCategoryEdit');
    ...
    ): array
    {
        return [
            ...
            'ru' => [
                'lang' => 'ru',
                'name' => 'category support update ru',
            ],
            'uk' => [
                'lang' => 'uk',
                'name' => 'category support update uk',
            ],
        ];
    }
