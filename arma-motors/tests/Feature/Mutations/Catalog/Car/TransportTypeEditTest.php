...
class TransportTypeEditTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $model = TransportType::where('id', 1)->first();
        ...
        $responseData = $response->json('data.transportTypeEdit');
