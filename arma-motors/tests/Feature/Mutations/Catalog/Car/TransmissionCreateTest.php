...
class TransmissionCreateTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $responseData = $response->json('data.transmissionCreate');
        ...
        $model = Transmission::where('id', $responseData['id'])->first();
