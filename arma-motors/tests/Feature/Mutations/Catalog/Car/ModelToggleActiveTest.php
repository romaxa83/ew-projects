...
class ModelToggleActiveTest extends TestCase
{
    ...
    public function toggle_success()
    {
        ...
        $responseData = $response->json('data.modelToggleActive');
    ...
    public function not_found_model()
    {
        ...
        $response = $this->postGraphQL(['query' => $this->getQueryStr('9999')])
            ->assertOk();
