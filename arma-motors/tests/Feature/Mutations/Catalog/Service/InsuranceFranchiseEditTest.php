...
class InsuranceFranchiseEditTest extends TestCase
{
    ...
    public function success()
    {
        ...
        $responseData = $response->json('data.insuranceFranchiseEdit');
    ...
    public function success_only_name()
    {
        ...
        $this->assertArrayHasKey('sort', $responseData);
        $this->assertArrayHasKey('name', $responseData);
        $this->assertNotEquals($model->name, $responseData['name']);
