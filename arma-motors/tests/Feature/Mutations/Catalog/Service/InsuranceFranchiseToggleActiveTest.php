...
class InsuranceFranchiseToggleActiveTest extends TestCase
{
    ...
    public function toggle_success()
    {
        ...
        $responseData = $response->json('data.insuranceFranchiseToggleActive');
    ...
    public static function getQueryStr(string $id): string
    {
        return sprintf('
            mutation {
                insuranceFranchiseToggleActive(id: "%s") {
                    id
                    active
                    sort
                }
