...
class CarOrderStatusEditTest extends TestCase
{
    ...
    public function success()
    {
        $admin = $this->adminBuilder()
            ->createRoleWithPerm(Permissions::CAR_ORDER_STATUS_EDIT)
            ->create();
        ...
        $responseData = $response->json('data.carOrderStatusEdit');
    ...
    public function success_only_translation()
    {
        ...
        $data = [
            ...
            'ru' => [
                'lang' => 'ru',
                'name' => 'some transport type ru',
            ],
            'uk' => [
                'lang' => 'uk',
                'name' => 'some transport type uk',
            ],
        ];
