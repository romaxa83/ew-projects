...
use App\Models\Storage\AwsPathGenerator;
...
//    'disk_name' => env('MEDIA_DISK', 'public'),
    ...
    /*
     * Имя таблицы для хранения данных о файлах
     */
    'table_name' => 'media',

    /*
     * Путь к каталогу на сервере, куда будут загружатся файлы для текущего приложения
     */
     ...
     */
    'max_file_size' => env('MEDIA_MAX_FILE_SIZE', 1024 * 1024 * 20),
     ...
     */
    'path_generator' => AwsPathGenerator::class,
