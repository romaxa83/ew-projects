...
class SetVehicleCommand implements RequestCommand
{
    const URI = '/api/v1/webhooks/vehicles/set';
    ...
    private function prepareData($data): array
    {
        ...
        if(isset($data['company_id'])){
            $trucks = Truck::query()
                ...
                ->with(['owner', 'tags', 'media'])
                ->where('carrier_id', $data['company_id'])
                ->get();
