...
class RequestActivate implements NotificationPatternContract
{
    private Device $device;
    private DeviceStatus $status;

    public function __construct(Device $device, DeviceStatus $status)
    {
        $this->device = $device;
        $this->status = $status;
    }
    ...
    public function create(): Notification
    {
        ...
        $model->meta = [
            ...
            'device_status' => $this->device->status->value,
            'device_request_status' => $this->device->status_request->value,
