...
class CompanySubscriptionUnpaid extends BaseNotificationService
{
    ...
    public function data(): array
    {
        return [
            ...
            'message_key' => 'notification.company_subscription.unpaid',
            'message_attr' => [
            ...
            'action' => NotificationAction::TO_DEVICE_ACTIVE_TILL
        ];
    }
}
