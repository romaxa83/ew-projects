...
use App\Http\Resources\Orders\BonusListResource;
...
class HistoryPaginatedResource extends JsonResource
{
     ...
     *
     * @OA\Schema(
     *    schema="HistoryDetailedResource",
     *    type="object",
     *    allOf={
     *        @OA\Schema(
     ...
     *            }),
     *           @OA\Property(property="meta", type="array", description="meta (different for different actions)", @OA\Items(
     *                  type="object",
     *                  allOf={
     *                      @OA\Schema(
     ...
     *
     * @OA\Schema(
     *    schema="HistoryPaginatedResource",
     *    @OA\Property(
     *        property="data",
    ...
    public function toArray($request)
    {
        ...
        return [
            ...
            'performed_timezone' => $this->performed_timezone,
        ];
    }
