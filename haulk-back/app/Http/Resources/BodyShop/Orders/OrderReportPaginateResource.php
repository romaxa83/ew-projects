 ...
 * @mixin Order
 */
class OrderReportPaginateResource extends JsonResource
{
    /**
     ...
     *
     * @OA\Schema(
     *     schema="OrderReportPaginateBS",
     *     @OA\Property(
     *         property="data",
     *         description="Order paginated list",
     *         type="array",
     *         @OA\Items(ref="#/components/schemas/OrderReportRawBS")
     *     ),
