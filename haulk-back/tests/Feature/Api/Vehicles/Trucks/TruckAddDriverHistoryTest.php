...
use Tests\Builders\Vehicles\TruckDriverHistoryBuilder;
use Tests\Helpers\Traits\AssertErrors;
use Tests\TestCase;

class TruckAddDriverHistoryTest extends TestCase
{
    use DatabaseTransactions;
    use AssertErrors;

    protected string $routeName = 'trucks.add-drivers-history';
    ...
    protected TruckDriverHistoryBuilder $truckDriverHistoryBuilder;
    ...
    protected function setUp(): void
    {
        ...
        $this->truckDriverHistoryBuilder = resolve(TruckDriverHistoryBuilder::class);
    ...
    public function success_add(): void
    {
        ...
        $this->assertEmpty($truck->histories);

        $this->postJson(route($this->routeName, $truck->id), $data)
            ->assertJson([
                'data' => [
                    [
                        'id' => $h_1->id,
    ...
    public function success_add_edit_rec_hit_start_at(): void
    {
        ...
        $h_3 = $this->truckDriverHistoryBuilder
            ->driver($driver)
            ->truck($truck)
            ->startAt($date->subHours(10))
            ->endAt($date->subHours(8))
    ...
    public function success_add_check_gps_history(): void
    {
        ...
        $truck->last_gps_history_id = $gps_h_5->id;
        $truck->save();
        ...
        $this->assertEquals($truck->last_gps_history_id, $gps_h_5->id);
    }
    ...
    public function success_add_check_gps_history_was_not_after_rec(): void
    {
        ...
        $truck->last_gps_history_id = $gps_h_2->id;
        $truck->save();
...
//        $this->assertEquals($truck->last_gps_history_id, $histories[0]->id);
    }
    ...
    public function success_add_check_gps_history_was_not_after_rec_but_have_between(): void
    {
        ...
        $truck->last_gps_history_id = $gps_h_3->id;
        $truck->save();
...
//        $this->assertEquals($truck->last_gps_history_id, $histories[0]->id);
    ...
    public function fail_not_driver(): void
    {
        ...
        $res = $this->postJson(route($this->routeName, $truck->id), $data)
        ;
    ...
    public function fail_driver_was_assigned_another_truck(): void
    {
        ...
        $this->assertResponseHasValidationMessage(
            $res,
            'start_at',
            __("exceptions.user.driver.history.driver_assigned_another_truck", [
                'unit_number' => $truckAnother->unit_number
            ])
        );
    }
