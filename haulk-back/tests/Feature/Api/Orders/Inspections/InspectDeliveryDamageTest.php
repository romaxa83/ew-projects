...
class InspectDeliveryDamageTest extends OrderTestCase
{
    ...
    public function test_it_upload_damage_photo_success(): void
    {
        ...
        $this->assertDatabaseMissing(
            File::TABLE_NAME,
            [
                'model_id' => $deliveryInspection->id,
        ...
        $this->postJson(
            route('mobile.orders.vehicles.inspect-delivery-damage', [$order->id, $vehicle->id]),
            [
    ...
    public function test_store_delivery_damage_labels(): void
    {
        Config::set('orders.inspection.max_photo', 1);
        ...
        $this->assertEquals($labels, $vehicle->deliveryInspection->damage_labels);
    }
}
