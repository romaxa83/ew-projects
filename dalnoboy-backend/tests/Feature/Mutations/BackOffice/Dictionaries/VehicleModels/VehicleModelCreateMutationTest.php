...
use App\GraphQL\Mutations\BackOffice\Dictionaries\VehicleModels\VehicleModelCreateMutation;
...
class VehicleModelCreateMutationTest extends TestCase
{
    ...
    public function test_create_vehicle_model(): void
    {
        ...
        $vehicleModelId = $this->postGraphQLBackOffice(
    ...
    public function test_create_vehicle_model_without_vehicle_make(): void
    {
        $vehicleModelData = [
            'active' => true,
            'title' => 'test title 2',
