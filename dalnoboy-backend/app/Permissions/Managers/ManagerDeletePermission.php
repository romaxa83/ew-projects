...
class ManagerDeletePermission extends BasePermission
{
    public const KEY = ManagerPermissionsGroup::KEY . '.delete';
    ...
    {
        return __('permissions.' . ManagerPermissionsGroup::KEY . '.grants.delete');
    }
