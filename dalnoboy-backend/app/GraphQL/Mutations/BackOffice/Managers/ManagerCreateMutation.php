...
use App\Permissions\Managers\ManagerCreatePermission;
...
class ManagerCreateMutation extends BaseMutation
{
    public const NAME = 'managerCreate';
    public const PERMISSION = ManagerCreatePermission::KEY;
