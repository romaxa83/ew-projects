...
{
    public function getUserByBearer(string $bearer): BasicAuthenticatable|Authenticatable|Subscribable|null
    {
        try {
    ...
    protected function login(string $bearer): BasicAuthenticatable|Authenticatable|Subscribable|null
    {
