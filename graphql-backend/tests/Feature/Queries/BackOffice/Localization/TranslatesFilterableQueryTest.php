...
class TranslatesFilterableQueryTest extends TestCase
{
    ...
    public function test_it_get_some_objects_for_admin(): void
    {
        ...
        Translate::factory()->times(50)->create(['place' => 'site', 'lang' => 'uk']);
    ...
    public function test_it_filter_by_place_for_admin(): void
    {
        ...
        Translate::factory()->times(15)->create(['place' => 'site', 'lang' => 'uk']);
        Translate::factory()->times(15)->create(['place' => 'admin', 'lang' => 'uk']);
        Translate::factory()->times(15)->create(['place' => 'some-place', 'lang' => 'uk']);
    ...
    public function test_it_filter_by_key_for_admin(): void
    {
        ...
        $key = 'some_key';
        $place = 'admin';
        Translate::factory()->times(1)->create(['place' => $place, 'key' => $key, 'lang' => 'uk']);
        Translate::factory()->times(25)->create(['place' => $place, 'lang' => 'uk']);
    ...
    public function test_it_filter_by_lang_for_admin(): void
    {
        ...
        $place = 'admin';
        Translate::factory()->times(15)->create(['place' => $place, 'lang' => 'uk']);
    ...
    public function test_it_has_limit_for_admin(): void
    {
        ...
        $place = 'admin';
        Translate::factory()->times(60)->create(['place' => $place, 'lang' => 'uk']);
    ...
    public function test_it_returns_pagination_meta_for_query(): void
    {
        ...
        Translate::factory()->times($total)->create(['place' => 'site', 'lang' => 'uk']);
