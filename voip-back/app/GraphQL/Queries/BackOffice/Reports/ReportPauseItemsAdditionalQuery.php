...
use App\GraphQL\Types\Reports\ReportPauseItemAdditionalType;
...
class ReportPauseItemsAdditionalQuery extends BaseQuery
{
    use ReportEmployeeGuard;

    public const NAME = 'ReportPauseItemsAdditional';
    ...
    {
        return ReportPauseItemAdditionalType::type();
    }
