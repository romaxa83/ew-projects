...
class SipUpdateMutation extends BaseMutation
{
    public const NAME = 'SipUpdate';
    public const PERMISSION = Permissions\Sips\UpdatePermission::KEY;
