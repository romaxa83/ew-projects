...
namespace App\PAMI\Client\Impl;

use App\PAMI\Message\OutgoingMessage;
use App\PAMI\Message\Message;
use App\PAMI\Message\IncomingMessage;
use App\PAMI\Message\Action\LoginAction;
use App\PAMI\Message\Response\ResponseMessage;
use App\PAMI\Message\Event\Factory\Impl\EventFactoryImpl;
use App\PAMI\Listener\IEventListener;
use App\PAMI\Client\Exception\ClientException;
use App\PAMI\Client\IClient;
 ...
 */
class ClientAMI implements IClient
{
    /**
     * PSR-3 logger.
     * @var LoggerInterface
     ...
     *
     * @throws \App\PAMI\Client\Exception\ClientException
     * @return void
     */
     ...
     *
     * @return \App\PAMI\Message\Response\ResponseMessage
     */
     ...
     *
     * @param \App\PAMI\Message\IncomingMessage $message Message to dispatch.
     *
     * @return void
     */
     ...
     * @param string $msg Raw string.
     *
     * @return \App\PAMI\Message\Event\EventMessage
     */
     ...
     *
     * @return \App\PAMI\Message\IncomingMessage
     */
     ...
     *
     * @param \App\PAMI\Message\OutgoingMessage $message Message to send.
     *
     * @see ClientAmi::send()
     * @throws \App\PAMI\Client\Exception\ClientException
     * @return \App\PAMI\Message\Response\ResponseMessage
