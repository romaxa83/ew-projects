...
return [
    ...
    'custom' => [
        'sip' => [
            'attached' => 'The sip is already linked to another user'
        ],
        'phone' => [
            'valid' => 'Phone should be provided in format: 380... and contain at least 10 digits'
        ],
        'attribute-name' => [
        ...
        'password' => [
            'password-rule' => 'Password should contains at least :min characters, at least 1 number and 1 capital latin letter'
        ],
        'name' => [
        ...
        'advertisement' => [
            'tag-from-foreign-category' => 'You can not use tag from other category',
            'action-only-for-received-agreement-request-company' => 'This action can perform only company that received agreement request',
        ],
    ],
