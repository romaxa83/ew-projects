...
return [
    ...
    */
    ...
    'email' => [
        'greeting' => 'Hello, :name!',
        'registration_subject' => 'OneVoiPlanet service registration',
        'change_subject' => 'OneVoiPlanet account changes',
        'registration_success' => 'You have been successfully registered on OneVoiPlanet',
