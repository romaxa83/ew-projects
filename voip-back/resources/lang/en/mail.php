...
return [
    'invitation' => [
        'greeting' => 'Hello, :name!',
        'subject' => 'You were invited to company',
        'line1' => 'Please, click on "SetUp password" button to start work',
        'line2' => 'Pay attention that link is active only for 72 hours!',
        'set-up-password' => 'SetUp password'
    ],
    'employee' => [
        'send_credential' => [
            'greeting' => 'Hello, :name!',
            'subject' => 'Register CRM CH',
