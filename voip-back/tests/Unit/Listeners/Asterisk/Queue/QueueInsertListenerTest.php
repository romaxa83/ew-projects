...
class QueueInsertListenerTest extends TestCase
{
    ...
    public function success_insert()
    {
        ...
        $this->assertEquals($queue->announce_holdtime, config('asterisk.queue.announce_holdtime'));
        $this->assertEquals($queue->announce_position, config('asterisk.queue.announce_position'));
    ...
    public function fail_insert()
    {
        ...
        $mockQueueService->shouldReceive('create')
            ->once()
