...
use App\GraphQL\Mutations\BackOffice\Auth\CheckPasswordTokenMutation;
...
class CheckPasswordTokenMutationTest extends TestCase
{
    use DatabaseTransactions;
    use CryptToken;

    public const MUTATION = CheckPasswordTokenMutation::NAME;
