...
class CreateOrUpdateTranslateMutationTest extends TestCase
{
    ...
    public function test_it_update_exists_translate_success(): void
    {
        ...
        $newAttributes['text'] = 'Some other not exists translate text';
        ...
        $this->assertDatabaseHas(Translation::TABLE, $attributes);
        $this->assertDatabaseMissing(Translation::TABLE, $newAttributes);
        ...
        $this->assertDatabaseMissing(Translation::TABLE, $attributes);
        $this->assertDatabaseHas(Translation::TABLE, $newAttributes);
    }
