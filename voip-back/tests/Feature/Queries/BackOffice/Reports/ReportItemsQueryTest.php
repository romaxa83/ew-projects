...
class ReportItemsQueryTest extends TestCase
{
    use DatabaseTransactions;

    public const QUERY = BackOffice\Reports\ReportItemsQuery::NAME;
    ...
    public function success_paginator(): void
    {
        ...
        $m_1 = $this->itemBuilder->setReport($report)->create();
        $m_2 = $this->itemBuilder->setReport($report)->create();
        $m_3 = $this->itemBuilder->setReport($report)->create();
        $this->itemBuilder->create();
    ...
    public function filter_by_from_date(): void
    {
        ...
        $item_1 = $this->itemBuilder->setReport($report)
            ->setCallAt($date->addDays(3))->create();
        $item_2 = $this->itemBuilder->setReport($report)
            ->setCallAt($date->addDays(1))->create();
        $item_3 = $this->itemBuilder->setReport($report)
            ->setCallAt($date->subDays(2))->create();
    ...
    public function search_by_name(): void
    {
        ...
        /** @var $report Report */
        $report = $this->reportBuilder->setEmployee($employee)->create();
        $report_1 = $this->reportBuilder->setEmployee($employee)->create();

        /** @var $item_1 Item */
        $m_1 = $this->itemBuilder->setReport($report)
            ->setData(['name' => 'jj' . $search])->create();
        $m_2 = $this->itemBuilder->setReport($report)
            ->setData(['name' => 'jj' . $search. 'yuyu'])->create();
        $m_3 = $this->itemBuilder->setReport($report)
            ->setData(['name' => 'jjyuiyu'])->create();
        $m_4 = $this->itemBuilder->setReport($report_1)
            ->setData(['name' => $search])->create();

        $this->postGraphQLBackOffice([
            'query' => $this->getQueryStrBySearch($report->id, $search)
        ])
            ->assertJson([
                'data' => [
                    self::QUERY => [
    ...
    public function search_by_phone(): void
    {
        ...
        /** @var $item_1 Item */
        $m_1 = $this->itemBuilder->setReport($report)
            ->setData(['num' => '67' . $search])->create();
        $m_2 = $this->itemBuilder->setReport($report)
            ->setData(['num' => $search. '99'])->create();
        $m_3 = $this->itemBuilder->setReport($report)
            ->setData(['num' => '1111'])->create();
        $m_4 = $this->itemBuilder->setReport($report_1)
            ->setData(['name' => $search])->create();
    ...
    protected function getQueryStrBySearch($reportID, string $value): string
    {
        return sprintf(
            '
            {
                %s (report_id: %s, search: "%s"){
                    data {
                        id
                    }
                    meta {
    ...
    /** @test */
    public function filter_bu_status(): void
    {
        $this->loginAsSuperAdmin();
        ...
        /** @var $item_1 Item */
        $m_1 = $this->itemBuilder->setReport($report)
            ->setData(['status' => ReportStatus::ANSWERED])->create();
        $m_2 = $this->itemBuilder->setReport($report)
            ->setData(['status' => ReportStatus::ANSWERED])->create();
        $m_3 = $this->itemBuilder->setReport($report)
            ->setData(['status' => ReportStatus::NO_ANSWER])->create();
        $m_4 = $this->itemBuilder->setReport($report)
            ->setData(['status' => ReportStatus::TRANSFER])->create();

        $this->postGraphQLBackOffice([
            'query' => $this->getQueryStrByStatus(ReportStatus::ANSWERED, $report->id)
        ])
            ->assertJson([
                'data' => [
                    self::QUERY => [
    ...
    protected function getQueryStrByStatus(string $value, $id): string
    {
        return sprintf(
            '
            {
