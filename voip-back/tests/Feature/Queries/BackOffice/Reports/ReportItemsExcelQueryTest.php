...
class ReportItemsExcelQueryTest extends TestCase
{
    use DatabaseTransactions;

    public const QUERY = BackOffice\Reports\ReportItemsExcelQuery::NAME;
        ...
        $this->postGraphQLBackOffice([
            ...
            ->assertJson([
                'data' => [
                    self::QUERY => [
                        'type' => 'success',
                        'message' => env('APP_URL') . "/storage/exports/reports/report-items-{$date->timestamp}.xlsx"
                    ]
                ]
            ])
        ;

        unlink(storage_path("app/public/exports/reports/report-items-{$date->timestamp}.xlsx"));
    }
