...
use App\GraphQL\Queries\BackOffice\Permissions\AdminRolesListQuery;
...
class AdminRolesListQueryTest extends TestCase
{
    use RoleHelperHelperTrait;
    use AdminSortable;
    use AdminFilterable;

    public const QUERY = AdminRolesListQuery::NAME;
    ...
    public function test_can_get_list_of_roles_for_permitted_admin(): void
    {
        ...
        $roles = $result->json('data.' . self::QUERY);
