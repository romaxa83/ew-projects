...
--
-- Host: 95.217.164.211    Database: kamailio
-- ------------------------------------------------------
...
CREATE TABLE `address` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `grp` int(10) unsigned NOT NULL DEFAULT 1,
...
CREATE TABLE `carrierroute` (
  ...
  `strip` int(10) unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE `dispatcher` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9359 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=133200 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `subscriber` (
  ...
  `web_pass` char(10) DEFAULT NULL,
  `route` char(6) DEFAULT NULL,
  `Description` varchar(32) DEFAULT NULL,
  `context` char(32) DEFAULT NULL,
  `ov_ip` char(32) DEFAULT NULL,
  `pickup_group` int(11) NOT NULL DEFAULT 0,
  `forward_unconditional_num` varchar(10) DEFAULT NULL,
  `uuid` varchar(36) DEFAULT NULL,
  `full_name` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `account_idx` (`username`,`domain`),
  KEY `username_idx` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=6092 DEFAULT CHARSET=latin1 COLLATE=latin1_swedish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-03-17  9:29:03
