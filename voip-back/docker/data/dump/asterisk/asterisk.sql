...
--
-- Host: 95.217.164.211    Database: asterisk
-- ------------------------------------------------------
...
CREATE TABLE `cdr` (
  ...
  `employee_uuid` varchar(250) DEFAULT NULL,
  `serial` varchar(25) DEFAULT NULL,
  `case_id` varchar(10) DEFAULT NULL,
  `department_uuid` varchar(128) DEFAULT NULL,
  `is_fetch` tinyint(1) DEFAULT NULL,
  `true_reason_hangup` varchar(45) DEFAULT NULL,
  `true_src` varchar(45) DEFAULT NULL,
  `from_employee_uuid` varchar(80) DEFAULT NULL,
...
CREATE TABLE `cel` (
  ...
  `eventextra` varchar(80) DEFAULT NULL,
  `userfield` varchar(255) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `uniqueid_index` (`uniqueid`),
  KEY `linkedid_index` (`linkedid`)
) ENGINE=InnoDB AUTO_INCREMENT=475146 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `ch_cdr`
--

DROP TABLE IF EXISTS `ch_cdr`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `ch_cdr` (
...
CREATE TABLE `queue_log` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=53708 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `queues` (
  ...
  `language_default` varchar(5) DEFAULT NULL,
...
CREATE TABLE `worktime` (
  ...
  `work_status` tinyint(1) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2023-07-06 13:23:12
