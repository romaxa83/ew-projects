...
return [
    ...
    'default' => env('DB_CONNECTION', DbConnections::DEFAULT),
    ...
    'connections' => [
        ...
        DbConnections::KAMAILIO => [
            ...
            'database' => env('KAMAILIO_DB_DATABASE', 'forge'),
            'username' => env('KAMAILIO_DB_USERNAME', 'forge'),
        ...
        DbConnections::ASTERISK => [
            ...
            'database' => env('ASTERISK_DB_DATABASE', 'forge'),
            'username' => env('ASTERISK_DB_USERNAME', 'forge'),
