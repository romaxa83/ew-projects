<html style="font-size: 8px;
    ...
    <body style="font-size: 8px; margin: 13mm; overflow: visible; padding: 0;">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td style="padding: 8px; border: 1px solid #E8E8E8;color: #171D2D;width: auto;padding: 4px 8px;vertical-align: top;border-collapse: collapse;">
                                                    <div style="margin-bottom: 4px;"><b style="font-weight: 700;">Payment receipt #: </b>{{ $transaction->invoice_number }}</div>
                                                    <div style="margin-bottom: 4px;"><b style="font-weight: 700;">Payment date: </b>{{ $paymentDate }}</div>
                                                    <div style="margin-bottom: 4px;"><b style="font-weight: 700;">Payment method: </b>{{ $paymentMethodName }}</div>
                                                </td>
                                                <td style="padding: 8px;border: 1px solid #E8E8E8;color: #171D2D;width: auto;padding: 4px 8px;vertical-align: top;border-collapse: collapse;">
                                ...
                                <div style="margin-bottom: 16px;">
                                    <table style="font-size: inherit;border: 1px solid #E8E8E8;width: 100%;padding: 0;margin: 0;vertical-align: top;border-collapse: collapse;">
                                        ...
                                        <tfoot>
                                            <tr>
                                                <td colspan="6"
                                                    style="border: 1px solid #E8E8E8;color: #171D2D;width: auto;vertical-align: top;border-collapse: collapse;background-color: #FAFAFA;font-size: 10px;font-weight: 700;text-align: right;padding: 8px;">
        ...
        <div style="position: fixed; top: 10mm; left: 12mm; width: 100%;color: #B9B9B9;height: 50px;">
            <div style="margin-bottom: 4px; color: #8C8C8C;">Payment receipt #: {{ $transaction->invoice_number }}</div>
            <div style=" color: #8C8C8C;">Payment receipt Date: {{ $paymentDate }}</div>
        </div>
    </body>
</html>
