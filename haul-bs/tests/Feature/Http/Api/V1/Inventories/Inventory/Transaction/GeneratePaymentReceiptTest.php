...
class GeneratePaymentReceiptTest extends TestCase
{
    ...
    public function success_generate()
    {
        ...
        $this->getJson(route('api.v1.inventories.transactions.generate-payment-receipt', [
            'id' => $transaction->id
        ]))
            ->assertOk()
        ;
    ...
    public function fail_operation_type_not_sold()
    {
        ...
        $res = $this->getJson(route('api.v1.inventories.transactions.generate-payment-receipt', [
            'id' => $transaction->id
        ]))
        ;
