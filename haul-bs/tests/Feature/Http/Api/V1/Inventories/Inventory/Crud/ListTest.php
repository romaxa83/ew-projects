...
class ListTest extends TestCase
{
    ...
    public function success_list_limit()
    {
        ...
        $this->getJson(route('api.v1.inventories.list', [
            'search' => 'alex',
        ]))
    ...
    public function not_perm()
    {
        ...
        $res = $this->getJson(route('api.v1.inventories.list', [
            'search' => 'rit',
        ]));
