...
class ShowTest extends TestCase
{
    ...
    public function success_show()
    {
        ...
        /** @var $model Trailer */
        $model = $this->trailerBuilder->tags($tag)->company($company)->create();

        $this->getJson(route('api.v1.vehicles.trailers.show', ['id' => $model->id]))
            ->assertJson([
                'data' => [
                    'id' => $model->id,
                    'vin' => $model->vin,
    ...
    public function fail_not_found()
    {
        ...
        $res = $this->getJson(route('api.v1.vehicles.trailers.show', ['id' => 0]))
        ;
    ...
    public function fail_not_found_as_deleted()
    {
        ...
        /** @var $model Trailer */
        $model = $this->trailerBuilder->delete()->create();

        $res = $this->getJson(route('api.v1.vehicles.trailers.show', ['id' => $model->id]))
        ;
