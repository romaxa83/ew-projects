...
class IndexTest extends TestCase
{
    ...
    public function success_list()
    {
        ...
        $this->getJson(route('api.v1.vehicles.trucks.list-comment', ['id' => $model->id]))
            ->assertJsonStructure([
                'data' => [
                    [
                        'id',
    ...
    public function fail_not_found()
    {
        ...
        $res = $this->getJson(route('api.v1.vehicles.trucks.list-comment', ['id' => 0]));
    ...
    public function not_perm()
    {
        ...
        $res = $this->getJson(route('api.v1.vehicles.trucks.list-comment', ['id' => $model->id]));
