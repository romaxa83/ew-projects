...
class CreateTest extends TestCase
{
    ...
    public function success_create()
    {
        ...
        $this->postJson(route('api.v1.vehicles.trucks'), $data)
            ->assertJsonStructure([
                'data' => [
                    'id',
                    'tags' => [
    ...
    public function success_create_check_history()
    {
        ...
        $id = $this->postJson(route('api.v1.vehicles.trucks'), $data)
            ->json('data.id')
        ;
    ...
    public function fail_create_with_files_more_file()
    {
        ...
        $res = $this->postJson(route('api.v1.vehicles.trucks'), $data)
        ;
    ...
    public function field_success_with_validate_only()
    {
        ...
        $this->assertDatabaseEmpty(Truck::TABLE);
    }
    ...
    public function field_wrong_tag()
    {
        ...
        $this->assertValidationMsg($res, __('validation.exists', ['attribute' => 'Tag']), 'tags.0');
    }
