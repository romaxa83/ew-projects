...
class DetailedTest extends TestCase
{
    ...
    public function success_pagination()
    {
        ...
        $this->getJson(route('api.v1.vehicles.trucks.detailed-history', ['id' => $model->id]))
            ->assertJsonStructure([
                'data' => [
                    [
                        'id',
    ...
    public function success_by_page()
    {
        ...
        $this->getJson(route('api.v1.vehicles.trucks.detailed-history', [
            'page' => 2,
            'id' => $model->id
        ]))
            ->assertJson([
    ...
    public function fail_not_found()
    {
        ...
        $res = $this->getJson(route('api.v1.vehicles.trucks.detailed-history', ['id' => 0]))
        ;
    ...
    public function not_perm()
    {
        ...
        $res = $this->getJson(route('api.v1.vehicles.trucks.detailed-history', ['id' => $model->id]));
