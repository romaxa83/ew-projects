...
class UpdateTest extends TestCase
{
    ...
    public function setUp(): void
    {
        ...
        $this->data = [
            ...
            'model' => 'Seria S',
            'license_plate' => 'S444s',
            'type' => VehicleType::VEHICLE_TYPE_TRUCK_SLEEPER,
    ...
    public function success_update()
    {
        ...
        /** @var $model Truck */
        $model = $this->truckBuilder->tags($tag)->create();
        ...
        $this->postJson(route('api.v1.vehicles.trucks.update', ['id' => $model->id]), $data)
            ->assertJson([
                'data' => [
    ...
    public function success_update_check_history()
    {
        ...
        $id = $this->postJson(route('api.v1.vehicles.trucks.update', ['id' => $model->id]), $data)
            ->json('data.id')
        ;

        /** @var $model Truck */
        $model = Truck::query()->where('id', $id)->first();
        ...
        $this->assertEquals($history->details['type'], [
            'old' => VehicleType::name($old->type),
            'new' => VehicleType::name(data_get($data, 'type')),
            'type' => 'updated',
        ]);
    ...
    public function success_update_file()
    {
        ...
        /** @var $model Truck */
        $model = $this->truckBuilder->attachments($file_2)->create();
    ...
    public function fail_more_more_file()
    {
        ...
        /** @var $model Truck */
        $model = $this->truckBuilder->attachments($file_1, $file_2, $file_3, $file_4)->create();

        $data = $this->data;
        $data[Vehicle::ATTACHMENT_FIELD_NAME] = [$file_5, $file_6];

        $res = $this->postJson(route('api.v1.vehicles.trucks.update', ['id' => $model->id]), $data)
        ;
    ...
    public function fail_not_found()
    {
        ...
        $res = $this->postJson(route('api.v1.vehicles.trucks.update', ['id' => 0]), $data)
        ;
    ...
    public static function validate(): array
    {
        return [
            ...
            ['type', null, 'validation.required', ['attribute' => 'Type']],
            ['type', 0, 'validation.in', ['attribute' => 'Type']],
