...
class ListTest extends TestCase
{
    ...
    public function success_list()
    {
        ...
        $this->getJson(route('api.v1.orders.bs.list-history', ['id' => $model->id]))
            ->assertJsonStructure([
                'data' => [
                    [
                        'id',
    ...
    public function fail_not_found()
    {
        ...
        $res = $this->getJson(route('api.v1.orders.bs.list-history', ['id' => 0]))
        ;
    ...
    public function not_perm()
    {
        ...
        $res = $this->getJson(route('api.v1.orders.bs.list-history', ['id' => $model->id]));
