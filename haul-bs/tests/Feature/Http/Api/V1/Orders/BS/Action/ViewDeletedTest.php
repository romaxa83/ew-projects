...
class ViewDeletedTest extends TestCase
{
    ...
    public function success_show()
    {
        ...
        $this->getJson(route('api.v1.orders.bs.view-deleted', ['id' => $model->id]))
            ->assertJson([
                'data' => [
                    'id' => $model->id,
    ...
    public function fail_not_found()
    {
        ...
        $res = $this->getJson(route('api.v1.orders.bs.view-deleted', ['id' => 0]))
        ;
    ...
    public function not_perm()
    {
        ...
        /** @var $model Order */
        $model = $this->orderBuilder->deleted()->create();

        $res = $this->getJson(route('api.v1.orders.bs.view-deleted', ['id' => $model->id]));
