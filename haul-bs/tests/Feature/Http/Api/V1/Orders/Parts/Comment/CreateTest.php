...
class CreateTest extends TestCase
{
    ...
    public function success_create()
    {
        ...
        $this->postJson(route('api.v1.orders.parts.add-comment', ['id' => $model->id]), $data)
            ->assertJsonStructure([
                'data' => [
                    'id',
                    'comment',
    ...
    public function fail_not_found()
    {
        ...
        $res = $this->postJson(route('api.v1.orders.parts.add-comment', ['id' => 0]),$data);
    ...
    public function not_perm()
    {
        ...
        $res = $this->postJson(route('api.v1.orders.parts.add-comment', ['id' => $model->id]), $data);
