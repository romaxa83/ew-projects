...
class UserListTest extends TestCase
{
    ...
    public function success_list()
    {
        ...
        $this->getJson(route('api.v1.orders.parts.history-users-list', ['id' => $model->id]))
            ->assertJsonStructure([
                'data' => [
                    [
                        'id',
    ...
    public function fail_not_found()
    {
        ...
        $res = $this->getJson(route('api.v1.orders.parts.history-users-list', ['id' => 0]))
        ;
    ...
    public function not_perm()
    {
        ...
        $res = $this->getJson(route('api.v1.orders.parts.history-users-list', ['id' => $model->id]));
