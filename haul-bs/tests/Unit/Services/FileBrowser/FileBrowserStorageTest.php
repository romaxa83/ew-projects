...
namespace Tests\Unit\Services\FileBrowser;
...
class FileBrowserStorageTest extends AbstractFileBrowserTest
{
    ...
    const FILE_BROWSER_ROOT = '/some/path';
    ...
    {
        Config::set('filebrowser.root', self::FILE_BROWSER_ROOT);
    ...
    public static function itConvertFullPathToRelativeDataProvider()
    {
        return [
    ...
    public static function itConvertArrayOfPathsToRelativesDataProvider()
    {
        return [
            [
                [
    ...
    public static function itGetCorrectFolderNameDataProvider()
    {
        return [
            ['/some/path', 'path'],
            ['/other', 'other'],
    ...
    public static function itGetExtensionSuccessDataProvider()
    {
        return [
    ...
    public static function itGetBasicNameSuccessDataProvider()
    {
        return [
            ['some/file.name', 'file'],
