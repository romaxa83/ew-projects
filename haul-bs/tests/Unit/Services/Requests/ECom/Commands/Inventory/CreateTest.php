...
class CreateTest extends TestCase
{
    ...
    public function check_prepare_data()
    {
        ...
        /** @var $command InventoryCreateCommand */
        $command = resolve(InventoryCreateCommand::class);
...
//        $this->assertEquals($res['gallery'][1]['id'], $model->getGallery()[1]->id);
    ...
    /** @test */
    public function check_prepare_data_float_qty()
    {
        /** @var $model Inventory */
        $model = $this->inventoryBuilder
            ->quantity(4.3)
        ...
        $this->assertEquals($res['quantity'],4);
    }
    ...
    public function check_uri()
    {
        ...
        $this->assertEquals($command->getUri(), config("requests.e_com.paths.inventory.create"));
    }
}
