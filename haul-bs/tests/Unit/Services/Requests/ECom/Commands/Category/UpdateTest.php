...
class UpdateTest extends TestCase
{
    ...
    public function check_prepare_data()
    {
        ...
        /** @var $command CategoryUpdateCommand */
        $command = resolve(CategoryUpdateCommand::class);
    ...
    public function check_uri()
    {
        ...
        $this->assertEquals(
            ...
            str_replace('{id}', $model->id, config("requests.e_com.paths.category.update"))
        );
    }
    ...
    public function fail_uri()
    {
        ...
        $this->expectExceptionMessage(
            "For this command [CategoryUpdateCommand] you need to pass 'guid' to uri"
        );
