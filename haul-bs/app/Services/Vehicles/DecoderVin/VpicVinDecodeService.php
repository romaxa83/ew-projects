...
class VpicVinDecodeService implements VinDecodeService
{
    ...
    private function getTypeFromVinData($body_class = null, $doors = null): ?int
    {
        switch ($body_class) {
            ...
            case 'Coupe':
                return VehicleType::VEHICLE_TYPE_COUPE_2;

            case 'Truck-Tractor':
                return VehicleType::VEHICLE_TYPE_TRUCK_DAYCAB;
            ...
            case 'Off-road Vehicle - All Terrain Vehicle (ATV) (Motorcycle-style)':
                return VehicleType::VEHICLE_TYPE_MOTORCYCLE;

            case 'Trailer':
                return VehicleType::VEHICLE_TYPE_TRAILER_BUMPER;
            ...
            case 'Incomplete - Trailer Chassis ':
                return VehicleType::VEHICLE_TYPE_PICKUP_4;

            case 'Pickup':
            case 'Truck':
                if ($doors && (int) $doors === 2) {
                    return VehicleType::VEHICLE_TYPE_PICKUP_2;
                }
            ...
            case 'Off-road Vehicle - Construction Equipment':
                return VehicleType::VEHICLE_TYPE_OTHER;
        }
