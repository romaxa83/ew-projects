...
class FileBrowserStorage
{
    ...
    /**
     * @param string|null $fileBrowserPrefix
     */
    public function setFileBrowserPrefix(?string $fileBrowserPrefix): void
    {
        $this->fileBrowserPrefix = $fileBrowserPrefix;
    }
    ...
    {
//        dd(config('filebrowser.root')
//            . DIRECTORY_SEPARATOR
//            . (
//            $this->fileBrowserPrefix ? $this->fileBrowserPrefix . DIRECTORY_SEPARATOR : ''
//            )
//            . remove_trailing_slashes($path));

        return config('filebrowser.root')
            . DIRECTORY_SEPARATOR
            . (
                $this->fileBrowserPrefix ? $this->fileBrowserPrefix . DIRECTORY_SEPARATOR : ''
            )
    ...
    public function getNameByPath(?string $path): string
    {
        ...
        return config('filebrowser.root_name');
    }
