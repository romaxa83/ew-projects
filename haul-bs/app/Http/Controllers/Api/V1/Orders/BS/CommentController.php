...
class CommentController extends ApiController
{
    ...
    /**
     * @OA\Get(
     *     path="/api/v1/orders/bs/{id}/comments",
     *     tags={"BS order"},
     *     security={{"Basic": {}}},
     *     summary="Get list comment for body shop order",
     *     operationId="GetListCommentForBSOrder",
     *     deprecated=false,
     *
     ...
     *     tags={"BS order"},
     *     security={{"Basic": {}}},
     *     summary="Create comment for body shop order",
     *     operationId="CreateCommentForBSOrder",
     *     deprecated=false,
     *
     *     @OA\Parameter(ref="#/components/parameters/Content-type"),
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
    ...
    {
        $this->authorize(Permission\Order\BS\OrderAddCommentPermission::KEY);
    ...
    /**
     * @OA\Delete(
     *     path="/api/v1/orders/bs/{id}/comments/{commentId}",
     *     tags={"BS order"},
     *     security={{"Basic": {}}},
     *     summary="Delete comment from body shop order",
     *     operationId="DeleteCommentFromBSOrder",
     *     deprecated=false,
     *
     *     @OA\Parameter(ref="#/components/parameters/Content-type"),
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
    ...
    {
        $this->authorize(Permission\Order\BS\OrderDeleteCommentPermission::KEY);
