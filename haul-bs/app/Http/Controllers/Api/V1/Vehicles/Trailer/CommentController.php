...
class CommentController extends ApiController
{
    ...
    /**
     * @OA\Get(
     *     path="/api/v1/trailers/{id}/comments",
     *     tags={"Vehicles trailer"},
     *     security={{"Basic": {}}},
     *     summary="Get list comment for trailer",
     *     operationId="GetListCommentForTrailer",
     *     deprecated=false,
     *
     ...
     *     tags={"Vehicles trailer"},
     *     security={{"Basic": {}}},
     *     summary="Create comment for trailer",
     *     operationId="CreateCommentForTrailer",
     *     deprecated=false,
     *
     *     @OA\Parameter(ref="#/components/parameters/Content-type"),
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
    ...
    {
        $this->authorize(Permission\Trailer\TrailerAddCommentPermission::KEY);
    ...
    /**
     * @OA\Delete(
     *     path="/api/v1/trailers/{id}/comments/{commentId}",
     *     tags={"Vehicles trailer"},
     *     security={{"Basic": {}}},
     *     summary="Delete comment from trailer",
     *     operationId="DeleteCommentFromTrailer",
     *     deprecated=false,
     *
     *     @OA\Parameter(ref="#/components/parameters/Content-type"),
     *     @OA\Parameter(ref="#/components/parameters/Accept"),
    ...
    {
        $this->authorize(Permission\Trailer\TrailerDeleteCommentPermission::KEY);
