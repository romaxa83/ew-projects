...
//            \Illuminate\Routing\Middleware\ThrottleRequests::class.':api',
            \App\Http\Middleware\CustomThrottleRequests::class.':260,1',
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
            'draft',
        ],
    ];
    ...
    protected $middlewareAliases = [
        ...
        'auth.webhook' => \App\Http\Middleware\WebhookAuth::class,
        'auth.e_comm' => \App\Http\Middleware\ECommAuth::class,
