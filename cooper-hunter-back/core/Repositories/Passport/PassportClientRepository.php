...
class PassportClientRepository
{
    ...
    public function findForTechnician(): ?Client
    {
        return $this->findFor('technicians');
    }

    public function findForModerator(): ?Client
    {
        return $this->findFor('1c_moderators');
    }

    public function findForDealer(): ?Client
    {
        return $this->findFor('dealers');
    }
}
