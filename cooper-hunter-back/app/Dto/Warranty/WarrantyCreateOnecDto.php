...
class WarrantyCreateOnecDto
{
    ...
    public ?string $commercialProjectGuid;
    ...
    public static function byArgs(array $args): self
    {
        ...
        $dto->systemID = data_get($args, 'system_id');
        $dto->commercialProjectGuid = data_get($args, 'commercial_project_guid');
        $dto->memberType = data_get($args, 'user_type');
        $dto->memberGuid = data_get($args, 'user_guid');
