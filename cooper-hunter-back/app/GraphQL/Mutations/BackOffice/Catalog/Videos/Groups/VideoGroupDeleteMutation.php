...
use App\Permissions\Catalog\Videos\Group\DeletePermission;
...
class VideoGroupDeleteMutation extends BaseMutation
{
    public const NAME = 'videoGroupDelete';
    ...
    public function doResolve($root, array $args, $context, ResolveInfo $info, SelectFields $fields): ResponseMessageEntity
    {
        try {
            ...
            return ResponseMessageEntity::success(__('messages.catalog.video.group.actions.delete.success.one-entity'));
        } catch (Throwable) {
