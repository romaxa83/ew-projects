...
class ProductKeywordCreateMutation extends BaseMutation
{
    public const NAME = 'productKeywordCreate';
    ...
    public function doResolve(
        ...
        return makeTransaction(
            fn() => $this->service->create(ProductKeywordDto::byArgs($args['input']))
        );
    }
}