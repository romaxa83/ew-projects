...
class AdditionalVideoPreviewDeleteMutation extends BaseMutation
{
    public const NAME = 'aboutCompanyAdditionalVideoPreviewDelete';
    ...
    public function doResolve(mixed $root, array $args, mixed $context, ResolveInfo $info, SelectFields $fields): bool
    {
        ...
        $about->clearMediaCollection(AboutCompany::ADDITIONAL_VIDEO_PREVIEW);
