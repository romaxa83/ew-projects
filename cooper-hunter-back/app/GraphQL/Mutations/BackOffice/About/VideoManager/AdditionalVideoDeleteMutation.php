...
class AdditionalVideoDeleteMutation extends BaseMutation
{
    public const NAME = 'aboutCompanyAdditionalVideoDelete';
    ...
    public function doResolve(mixed $root, array $args, mixed $context, ResolveInfo $info, SelectFields $fields): bool
    {
        ...
        $about->clearMediaCollection(AboutCompany::ADDITIONAL_MEDIA_SHORT_VIDEO);
