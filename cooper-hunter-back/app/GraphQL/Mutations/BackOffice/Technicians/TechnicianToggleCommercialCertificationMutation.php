...
class TechnicianToggleCommercialCertificationMutation extends BaseMutation
{
    public const NAME = 'technicianToggleCommercialCertification';
    ...
    {
        return $this->service->toggleCommercialCertification(
