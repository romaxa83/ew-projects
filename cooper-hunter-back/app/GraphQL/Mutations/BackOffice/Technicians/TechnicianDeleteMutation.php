...
class TechnicianDeleteMutation extends BaseMutation
{
    public const NAME = 'technicianDelete';
    public const PERMISSION = TechnicianDeletePermission::KEY;
