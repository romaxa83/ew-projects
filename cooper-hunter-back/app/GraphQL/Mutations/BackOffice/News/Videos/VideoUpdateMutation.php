...
use App\GraphQL\InputTypes\News\Videos\VideoUpdateInput;
...
class VideoUpdateMutation extends BaseMutation
{
    public const NAME = 'videoUpdate';
    ...
    {
        return [
            'video' => VideoUpdateInput::nonNullType(),
        ];
    }
    ...
    protected function rules(array $args = []): array
    {
        return [
            'video.slug' => [
                Rule::unique(Video::class, 'slug')->ignore($args['video']['id'])
            ]
        ];
    }
}
