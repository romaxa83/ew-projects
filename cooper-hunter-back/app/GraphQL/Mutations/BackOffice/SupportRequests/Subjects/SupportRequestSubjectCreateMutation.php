...
class SupportRequestSubjectCreateMutation extends BaseMutation
{
    public const NAME = 'supportRequestSubjectCreate';
    public const PERMISSION = SupportRequestSubjectCreatePermission::KEY;
