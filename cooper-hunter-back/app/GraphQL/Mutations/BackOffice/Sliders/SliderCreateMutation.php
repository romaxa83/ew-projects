...
use App\Permissions\Sliders\SliderCreatePermission;
...
class SliderCreateMutation extends BaseMutation
{
    public const NAME = 'sliderCreate';
    public const PERMISSION = SliderCreatePermission::KEY;
