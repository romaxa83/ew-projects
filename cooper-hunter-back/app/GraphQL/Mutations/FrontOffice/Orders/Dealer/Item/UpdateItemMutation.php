...
use App\GraphQL\Types\Orders\Dealer\ItemType;
...
class UpdateItemMutation extends BaseMutation
{
    use DealerInspector;

    public const NAME = 'dealerOrderUpdateItem';
    ...
    ): Item
    {
        ...
        $model = makeTransaction(
            fn(): Item => $this->service->update($model, $args['qty'])
        );
