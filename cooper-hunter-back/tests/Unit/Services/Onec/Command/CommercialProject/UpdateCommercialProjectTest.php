...
class UpdateCommercialProjectTest extends TestCase
{
    ...
    public function success_send()
    {
        ...
        $this->assertEquals($record->command, RequestCommand::UPDATE_COMMERCIAL_PROJECT);
    ...
    public function check_transform_data()
    {
        ...
        $command = (new UpdateCommercialProject($sender,));
