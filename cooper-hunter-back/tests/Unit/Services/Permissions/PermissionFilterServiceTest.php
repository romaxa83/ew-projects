...
class PermissionFilterServiceTest extends TestCase
{
    ...
    public function test_get_service_as_singleton(): void
    {
        self::assertEquals(
            ...
            spl_object_id(app(PermissionFilterService::class))
        );
    }
    ...
    public function test_user_get_empty_permissions(): void
    {
        ...
        $permissions = collect(
            [
                Permission::create(['name' => 'test_'.UserCreatePermission::KEY]),
                Permission::create(['name' => 'test_'.UserListPermission::KEY]),
            ]
        );
        ...
        self::assertTrue(
            $permissions->where('name', 'test_'.UserListPermission::KEY)->isNotEmpty()
        );
    }
    ...
    protected function setUp(): void
    {
        ...
        $this->service = app(PermissionFilterService::class);
