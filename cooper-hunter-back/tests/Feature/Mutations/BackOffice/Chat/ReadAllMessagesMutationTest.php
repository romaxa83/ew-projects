...
use App\GraphQL\Mutations\BackOffice\Chat\ReadAllMessagesMutation;
...
class ReadAllMessagesMutationTest extends TestCase
{
    use DatabaseTransactions;

    public const MUTATION = ReadAllMessagesMutation::NAME;
