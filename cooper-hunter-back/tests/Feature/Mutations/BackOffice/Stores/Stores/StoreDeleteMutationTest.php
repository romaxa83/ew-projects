...
use App\GraphQL\Mutations\BackOffice\Stores\Stores\StoreDeleteMutation;
...
class StoreDeleteMutationTest extends TestCase
{
    use DatabaseTransactions;

    public const MUTATION = StoreDeleteMutation::NAME;
