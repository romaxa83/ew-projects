...
use App\GraphQL\Mutations\BackOffice\Catalog\Certificates\Certificate\CertificateDeleteMutation;
use App\Models\Admins\Admin;
use App\Models\Catalog\Certificates\Certificate as CertificateModel;
...
class DeleteTest extends TestCase
{
    ...
    public const MUTATION = CertificateDeleteMutation::NAME;
    ...
    public function success(): void
    {
        ...
        $this->loginByAdminManager([Certificate\DeletePermission::KEY]);
        ...
        $this->assertEquals(
            __('messages.catalog.certificate.certificate.actions.delete.success.one-entity'),
            $res->json(sprintf('data.%s.message', self::MUTATION))
        );

        $this->assertNull(CertificateModel::find($data['id']));
    }
