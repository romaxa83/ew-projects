...
use App\GraphQL\Mutations\BackOffice\Catalog\Certificates\Type\CertificateTypeDeleteMutation;
...
class DeleteTest extends TestCase
{
    ...
    public const MUTATION = CertificateTypeDeleteMutation::NAME;
    ...
    public function success(): void
    {
        ...
        $this->loginByAdminManager([Type\DeletePermission::KEY]);
        ...
        $this->assertEquals(
            __('messages.catalog.certificate.type.actions.delete.success.one-entity'),
            $res->json(sprintf('data.%s.message', self::MUTATION))
        );

        $this->assertNull(CertificateType::find($data['id']));
    }
