...
class AdminResourceRegistrar extends ResourceRegistrar
{
    ...
    protected function addResourceSettings($name, $base, $controller, $options)
    {
        ...
        $this->router->get(
            $uri . '/settings/form',
            ['as' => $name . '.settings', 'uses' => $controller . '@settingsForm']
        );
    ...
    {
        return $this->router->delete(
            $this->getResourceUri($name) . '/delete-image/{id}',
    ...
    {
        return $this->router->delete(
            $this->getResourceUri($name) . '/delete-file/{id}',
    ...
    protected function getResourceMethods($defaults, $options)
    {
        ...
        // sort methods
        return collect($methods)->sortBy(function ($method) {
