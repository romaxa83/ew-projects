...
trait ImageAttachable
{
     ...
     *         'replicate' => true, // Copy images when replicating a model.
     ...
     */
    public function getImageUrl(string $size = null, string $field = ImageService::IMAGE, string $locale = null)
    {
     ...
     */
    public function replicateImages(?array $fields = [])
    {
        app(ImageService::class)->replicate($this, $fields);
    }
