...
trait FileAttachable
{
     ...
     * @return Carbon|null
     */
    public function getFileLastModified(string $field = FileService::FILE, string $locale = null): ?Carbon
    {
        return app(FileService::class)->getFileLastModified($this, $field, $locale);
    }
