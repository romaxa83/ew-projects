                                    ...
                                    <div class="p-t-10 tab-pane {{ $loop->first ? 'active' : null }}"
                                        ...
                                        @foreach($tabEl['fields'] as $row)
                                            @if ($row instanceof \WezomCms\Core\Settings\MultilingualGroup)
                                                <ul class="nav nav-tabs customtab js-lang-tabs js-copy-lang-fields" @if(count(app('locales')) < 2) hidden @endif role="tablist" data-locales="{{ json_encode(array_keys(app('locales'))) }}">
                                            ...
                                            @else
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    @if($row->isMultilingual())
                                                        <ul class="nav nav-tabs customtab js-lang-tabs js-copy-lang-fields" role="tablist" @if(count(app('locales')) < 2) hidden @endif data-locales="{{ json_encode(array_keys(app('locales'))) }}">
                                                            @foreach($locales as $locale => $language)
                                                                <li class="nav-item">
