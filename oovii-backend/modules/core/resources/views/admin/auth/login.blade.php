                    ...
                    <div class="login-content card">
                        <div class="login-form">
                            ...
                            <div class="form-group">
                                ...
                                {!! Form::email('email', old('email'), ['placeholder' => __('cms-core::admin.auth.E-Mail'), 'required' => 'required', 'autofocus' => true, 'tabindex' => '1']) !!}
                            </div>
                            <div class="form-group">
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div>
                                    ...
                                    <a href="{{ route('admin.register') }}">@lang('cms-core::admin.auth.Register')</a>
                                </div>
                            </div>
