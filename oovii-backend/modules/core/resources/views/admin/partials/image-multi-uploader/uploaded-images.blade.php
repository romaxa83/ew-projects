@php
/**
 * @var $images \WezomCms\Core\Traits\Model\ImageAttachable[]|\Illuminate\Database\Eloquent\Model[]
 */
@endphp
    ...
    <div class="loadedBlock" data-image="{{ $image->id }}">
        ...
        <div class="loadedControl">
            ...
            <div class="loadedCtrl loadedView">
                <a href="{{ $image->getExistImageUrl(\WezomCms\Core\Image\ImageService::ORIGINAL) ?: $image->withoutWebp()->getImageUrl(array_get($options, 'preview_size')) }}"
