@php
     ...
     */
@endphp
{!! Form::open(['url' => route('admin.image-multi-uploader.rename', [$obj->id, 'model' => encrypt($model)]), 'class' => 'js-rename-image-form js-force-valid']) !!}
...
<div class="modal-body">
    ...
    <script>
        ...
        window.inits.simpleAjaxFormSubmit('.js-rename-image-form');
