                        ...
                        <div class="form-group">
                            @switch($field->getType())
                                ...
                                @if(array_get($field->getAttributes(), 'multiple'))
                                    ...
                                    @endphp
                                    {!! Form::select($field->getName(), $options, array_get($values, \WezomCms\Core\Foundation\Helpers::convertFieldToDot($field->getName())), ['class' => $field->getClass(), 'data-placeholder' => $field->getPlaceholder(), 'style' => 'width: 100%'] + $field->getAttributes(), $optionAttributes) !!}
                                @else
