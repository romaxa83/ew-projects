...
return [
    TranslationSide::SITE => [
        ...
        'To enter your Personal Account you need to log in' => 'Щоб увійти в особистий кабінет потрібно авторизуватися',
        ...
        'or' => 'або',
        'You must accept privacy terms' => 'Ви повинні прийняти угоди користувача',
    ],
];
