...
return [
    TranslationSide::ADMIN => [
        ...
        'auth' => [
            ...
            'Sign in' => 'Войти',
            'Sign up' => 'Отправить заявку на регистрацию',
        ...
        'layout' => [
            ...
            'Register request created' => 'Заявка на регистрацию отправлены, ждите потвержденния',
        ...
        'validation' => [
            "wrong_phone_format" => "Неверный формат телефона, допустимый - +380XXXXXXXXX или +7XXXXXXXXXX"
        ],
        'Region' => 'Область',
        'City' => 'Город',
    ],
    TranslationSide::SITE => [
        ...
        'To enter your Personal Account you need to log in' => 'Чтобы войти в Личный кабинет нужно авторизоваться',
        ...
        'You must accept privacy terms' => 'Вы должны принять условия пользовательского соглашения',
    ],
];
